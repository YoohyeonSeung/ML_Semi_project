...
#                 if(dirn=="test"):
#                     if (subdir == "NORMAL"):
#                         outfile = os.path.join(path, '/workspaces/ML_Semi_project/HS/data/resized_test/'+subdir,
...
#                 else:
#                     if (subdir == "NORMAL"):
#                         outfile = os.path.join(path, '/workspaces/ML_Semi_project/HS/data/resized_train/'+subdir,
#                                                classes[0] + str(cnt) + upper_ext)
#                     else:
#                         outfile = os.path.join(path, '/workspaces/ML_Semi_project/HS/data/resized_train/'+subdir,
#                                                classes[1] + str(cnt) + upper_ext)
...
model = Sequential()
model.add(Conv2D(2, kernel_size=(40, 40),
                 strides=5,
                 activation='relu',
                 input_shape=(1280,1280,3)))
model.add(Conv2D(4, (26, 26),
                 strides=5,
                 activation='relu'))
